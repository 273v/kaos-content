...
See [CONTRIBUTING.md](https://github.com/273v/kaos-content/blob/main/CONTRIBUTING.md)
...
- [ ] `uv run ruff format --check kaos_content/ tests/` passes
- [ ] `uv run ruff check kaos_content/ tests/` passes
- [ ] `uv run ty check kaos_content/ tests/` passes
