...
This document defines how `kaos-content` handles features, bugs,
...
- What `kaos-content` version, platform, Python version, and installation
  method are involved?
...
- Fresh install smoke test that imports `kaos_content`.
